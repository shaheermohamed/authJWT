...
const Login = () => {
  ...
  const handleClickLogin = (data) => {
    axios
      .post(
        "https://authjwt-backend.onrender.com/auth/login"
    ...
    <div>
      ...
      <Row justify="center">
        <Col xxl={6} xl={8} md={12} sm={18} xs={24}>
          <div  style={{}} className="mt-20 bg-white rounded-md dark:bg-white10 shadow-regular dark:shadow-none border border-slate-300">
